...
namespace Ccr.Std.Core.Extensions.NumericExtensions
{
	...
	public static class UInt64Extensions
	{
		...
		///		<see cref="UInt64"/> subject with the provided <paramref name="value"/> parameter, and returns 
		///		the largest numeric <see cref="UInt64"/> value of the two.
		/// </summary>
		/// <param name="this">
		///		The subject <see cref="UInt64"/> to perform the comparison upon.
		/// </param>
		/// <param name="value">
		///		The value of type <see cref="UInt64"/> in which to perform the comparison against the extension 
		///		method's subject, the <paramref name="this"/> parameter.
		/// </param>
		/// <returns>
		///		Compares the extention method's <see cref="UInt64"/> subject and the <paramref name="value"/> 
		///		parameter, and returns the largest numeric <see cref="UInt64"/> value of the two. 
		/// </returns>
		...
		/// <summary>
		///		Extension method that performs a transformation on the <see cref="UInt64"/> subject using
		...
		/// </summary>
		/// <param name="this">
		///		The subject <see cref="UInt64"/> to perform the linear map range re-mapping upon.
		/// </param>
		...
		///	</exception>
		/// <returns>
		///		A <see cref="UInt64"/> value that has been linearly mapped to the <paramref name="startRange"/>
		///		parameter and re-mapped to the <paramref name="endRange"/> parameter.
		/// </returns>
		public static UInt64 LinearMap(
			this UInt64 @this,
			[NotNull] UInt64Range startRange,
			[NotNull] UInt64Range endRange)
		{
		...
		///	</exception>
		/// <returns>
		///		A <see cref="UInt64"/> value that is the <paramref name="this"/> subject value adjusted to
		...
		/// </returns>
		public static UInt64 Constrain(
			this UInt64 @this,
			[NotNull] UInt64Range range)
		{
			range.IsNotNull(nameof(range));
