...
namespace Ccr.Std.Core.Extensions.NumericExtensions
{
	public static class Int64Extensions
	{
		...
		///		<see cref="Int64"/> subject with the provided <paramref name="value"/> parameter, and returns 
		///		the largest numeric <see cref="Int64"/> value of the two.
		/// </summary>
		/// <param name="this">
		///		The subject <see cref="Int64"/> to perform the comparison upon.
		/// </param>
		/// <param name="value">
		///		The value of type <see cref="Int64"/> in which to perform the comparison against the extension 
