...
namespace Ccr.MaterialDesign.Primitives.Behaviors.Services
{
       ...
       IFrameworkInputElement>
  {
      ...
      RoutedEventArgs args)
    {
      ...
      var inputDataAdapter = frameworkElement
        .GetInputDataAdapter();
    ...
    private void OnLostKeyboardFocus(
      object sender, 
      KeyboardFocusChangedEventArgs args)
    {
      ...
      [CanBeNull] TextCompositionEventArgs aggressiveValidationArgs = null)
    {
      ...
      {
        var effectiveText = frameworkElement
          .GetEffectiveText(
            aggressiveValidationArgs);
