...

{
		...
		: HostedElement<FrameworkElement>
	{
		...
		private void OnHostManipulationDelta(
			object sender,
			ManipulationDeltaEventArgs args)
		{
		}

		private void OnHostManipulationInertiaStarting(
			object sender, 
			ManipulationInertiaStartingEventArgs args)
		{
		}

		private void OnHostManipulationStarted(
			object sender, 
		...
		private void OnHostManipulationCompleted(
			object sender, 
			ManipulationCompletedEventArgs args)
		{
		}

		private void OnHostManipulationStarting(
			object sender, 
		...
		private void OnHostGotFocus(
			object sender,
			RoutedEventArgs routedEventArgs)
		{
		}
		private void OnHostLostFocus(
			object sender,
			RoutedEventArgs routedEventArgs)
		{
		}

		private void OnIsMouseDirectlyOverHostChanged(
			object sender, 
			DependencyPropertyChangedEventArgs args)
		{
		}

		private void OnHostMouseMove(
			object sender, 
		...
		private void OnHostGotStylusCapture(
			object sender, 
			StylusEventArgs args)
		{
		}
		private void OnHostLostStylusCapture(
			object sender,
			StylusEventArgs args)
		{
		}

		private void OnHostGotKeyboardFocus(
			object sender, 
			KeyboardFocusChangedEventArgs args)
		{
		}
		private void OnHostLostKeyboardFocus(
			object sender,
			KeyboardFocusChangedEventArgs args)
		{
		}

		private void OnHostGotTouchCapture(
			object sender, 
			TouchEventArgs touchEventArgs)
		{
		}
		private void OnHostLostTouchCapture(
			object sender, 
			TouchEventArgs touchEventArgs)
		{
		}
