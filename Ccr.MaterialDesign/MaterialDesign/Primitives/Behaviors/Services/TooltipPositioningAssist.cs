...
namespace Ccr.MaterialDesign.Primitives.Behaviors.Services
{
	...
	{
		public static readonly DependencyProperty PositioningServiceProperty = DependencyProperty.RegisterAttached(
			"PositioningService", typeof(TooltipPositioningService), typeof(TooltipPositioningAssist),
