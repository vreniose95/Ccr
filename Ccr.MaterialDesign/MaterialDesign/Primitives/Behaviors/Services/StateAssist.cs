...
namespace Ccr.MaterialDesign.Primitives.Behaviors.Services
{
	public class StateAssist
	{
		public static readonly DependencyProperty State1Property = DependencyProperty.RegisterAttached(
			"State1", typeof(string), typeof(StateAssist),
		...
		public static readonly DependencyProperty State2Property = DependencyProperty.RegisterAttached(
			"State2", typeof(string), typeof(StateAssist),
		...
		public static readonly DependencyProperty State3Property = DependencyProperty.RegisterAttached(
			"State3", typeof(string), typeof(StateAssist),
		...
		public static readonly DependencyProperty State4Property = DependencyProperty.RegisterAttached(
			"State4", typeof(string), typeof(StateAssist),
		...
		public static readonly DependencyProperty State5Property = DependencyProperty.RegisterAttached(
			"State5", typeof(string), typeof(StateAssist),
		...
		public static readonly DependencyProperty State6Property = DependencyProperty.RegisterAttached(
			"State6", typeof(string), typeof(StateAssist),
		...
		public static readonly DependencyProperty State7Property = DependencyProperty.RegisterAttached(
			"State7", typeof(string), typeof(StateAssist),
		...
		public static readonly DependencyProperty State8Property = DependencyProperty.RegisterAttached(
			"State8", typeof(string), typeof(StateAssist),
		...
		public static readonly DependencyProperty State9Property = DependencyProperty.RegisterAttached(
			"State9", typeof(string), typeof(StateAssist),
		...
		{
			return (string)obj.GetValue(State1Property);
		}
		...
		{
			return (string) obj.GetValue(State2Property);
		}
		...
		{
			return (string) obj.GetValue(State3Property);
		}
		...
		{
			return (string) obj.GetValue(State4Property);
		}
		...
		{
			return (string) obj.GetValue(State5Property);
		}
		...
		{
			return (string) obj.GetValue(State6Property);
		}
		...
		{
			return (string) obj.GetValue(State7Property);
		}
		...
		{
			return (string) obj.GetValue(State8Property);
		}
		...
		{
			return (string) obj.GetValue(State9Property);
		}
		...
		private static void State1Changed(DependencyObject target, DependencyPropertyChangedEventArgs args)
		{
			if (args.NewValue != null)
				VisualStateManager.GoToState((FrameworkElement)target, (string)args.NewValue, true);
		}

		private static void State2Changed(DependencyObject target, DependencyPropertyChangedEventArgs args)
		{
			if (args.NewValue != null)
				VisualStateManager.GoToState((FrameworkElement)target, (string)args.NewValue, true);
		}

		private static void State3Changed(DependencyObject target, DependencyPropertyChangedEventArgs args)
		{
			if (args.NewValue != null)
				VisualStateManager.GoToState((FrameworkElement)target, (string)args.NewValue, true);
		}

		private static void State4Changed(DependencyObject target, DependencyPropertyChangedEventArgs args)
		{
			if (args.NewValue != null)
				VisualStateManager.GoToState((FrameworkElement)target, (string)args.NewValue, true);
		}

		private static void State5Changed(DependencyObject target, DependencyPropertyChangedEventArgs args)
		{
			if (args.NewValue != null)
				VisualStateManager.GoToState((FrameworkElement)target, (string)args.NewValue, true);
		}

		private static void State6Changed(DependencyObject target, DependencyPropertyChangedEventArgs args)
		{
			if (args.NewValue != null)
				VisualStateManager.GoToState((FrameworkElement)target, (string)args.NewValue, true);
		}

		private static void State7Changed(DependencyObject target, DependencyPropertyChangedEventArgs args)
		{
			if (args.NewValue != null)
				VisualStateManager.GoToState((FrameworkElement)target, (string)args.NewValue, true);
		}

		private static void State8Changed(DependencyObject target, DependencyPropertyChangedEventArgs args)
		{
			if (args.NewValue != null)
				VisualStateManager.GoToState((FrameworkElement)target, (string)args.NewValue, true);
		}

		private static void State9Changed(DependencyObject target, DependencyPropertyChangedEventArgs args)
		{
			if (args.NewValue != null)
				VisualStateManager.GoToState((FrameworkElement)target, (string)args.NewValue, true);
		}
