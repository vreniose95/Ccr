...
namespace Ccr.MaterialDesign.Primitives.Behaviors
{
	public static class MDH
	{
		...
		public static MaterialIdentity GetIdentity(DependencyObject @this)
		{
		...
		private static void onThemeChanged(DependencyObject @this, DPChangedEventArgs<Swatch> args)
		{
		}

		private static void onSwatchChanged(DependencyObject @this, DPChangedEventArgs<SwatchClassifier> args)
		{
			var swatch = GlobalResources.Palette.GetSwatch(args.NewValue);
			SetTheme(@this, swatch);
		}

		private static void onIdentityChanged(DependencyObject @this, DPChangedEventArgs<MaterialIdentity> args)
		{
