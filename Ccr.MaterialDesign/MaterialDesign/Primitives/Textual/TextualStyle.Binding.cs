...
namespace Ccr.MaterialDesign.Primitives.Textual
{
	...
	public partial class TextualStyle
	{
		...
		public static readonly DependencyProperty BindingRelativeSourceProperty = DP.Attach(
			_type, new MetaBase<RelativeSource>(
				_defaultBindingRelativeSource,
				(@this, args) => onDependentPropertyChanged(@this, args)));


		//TODO change name, just source not relativesource?
		public static readonly DependencyProperty ForegroundMaterialSetRelativeSourceProperty = DP.Attach(
			_type, new MetaBase<DependencyObject>(
				null,
				(@this, args) => onDependentPropertyChanged(@this, args)));
		...
		public static readonly DependencyProperty IsHighContrastBindingProperty = DP.Attach(
			_type, new MetaBase<bool>(
				false, (@this, args) => onDependentPropertyChanged(@this, args)));

		public static readonly DependencyProperty HighContrastBindingContextProperty = DP.Attach(
			_type, new MetaBase<SolidColorBrush>(
				null, (@this, args) => onDependentPropertyChanged(@this, args)));
			...
			switch (textualStyle.TextRotation)
			{
				...
				default:
					throw new InvalidEnumArgumentException(
						nameof(textualStyle.TextRotation),
						(int)textualStyle.TextRotation,
						typeof(TextRotation));
			}
