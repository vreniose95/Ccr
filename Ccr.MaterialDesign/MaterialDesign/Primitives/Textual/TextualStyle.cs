...
namespace Ccr.MaterialDesign.Primitives.Textual
{
		...
		: Freezable
	{
		public static readonly DependencyProperty ForegroundDescriptorProperty = DP.Register(
			new Meta<TextualStyle, AbstractMaterialDescriptor>(Static.Descriptors.A100Descriptor));

		public static readonly DependencyProperty FontFamilyProperty = TextElement.FontFamilyProperty.Add(
			new Meta<TextualStyle, FontFamily>(Static.Text.Fonts.Roboto));

		public static readonly DependencyProperty FontWeightProperty = TextElement.FontWeightProperty.Add(
			new Meta<TextualStyle, FontWeight>());

		public static readonly DependencyProperty FontStretchProperty = TextElement.FontStretchProperty.Add(
			new Meta<TextualStyle, FontStretch>());

		public static readonly DependencyProperty RelativeFontSizeProperty = DP.Register(
			new Meta<TextualStyle, double>(1d));

		public static readonly DependencyProperty FontStyleProperty = TextElement.FontStyleProperty.Add(
			new Meta<TextualStyle, FontStyle>());
