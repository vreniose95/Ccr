...
namespace Ccr.Xaml.Markup.Converters.Infrastructure
{
    ...
    : ConverterParam
  {
    ...
    protected virtual T14 ConvertArg14(object arg)
    {
	    return XamlUtilities.Convert<T14>(arg, this);
    }

    protected virtual T15 ConvertArg15(object arg)
    {
	    return XamlUtilities.Convert<T15>(arg, this);
    }
