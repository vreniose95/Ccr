...
namespace Ccr.Core.Extensions.NumericExtensions
{
  public static class ByteExtensions
  {
    ...
    /// <summary>
    ///   Extension method that scales a <see cref="byte"/> subject value down by a <see cref="double"/>
    ///   percentage. This value must be between [0.00 to 1.00], inclusively.
    /// </summary>
    /// <param name="this">
    ///   The subject <see cref="byte"/> value in which to scale down.
    /// </param>
    /// <param name="percent">
    ///   A <see cref="double"/> value indicating the percentage to scale the <paramref name="this"/> value.
    ///   This value must be between [0.00 to 1.00], inclusively.
    /// </param>
    /// <returns>
    ///   Returns the scaled down version off the <see cref="byte"/> value, converted to a <see cref="byte"/>. 
    /// </returns>
...
/*
      ...
      //if (percent.IsNotWithin((byte.MinValue, byte.MaxValue)))
      //  throw new 
